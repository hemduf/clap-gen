...
use super::{
    GenerationPlan, OUTPUT_NAMES, extension_cpp, instance_backend_cpp, render,
};
...
fn issue51_review_requires_null_binding_safety_and_deterministic_owned_binding_order() {
    ...
    let latency = extension_cpp::OwnedPluginExtension {
        id: "clap.latency",
        table_symbol: "latency_table",
    };
    let tail = extension_cpp::OwnedPluginExtension {
        id: "clap.tail",
        table_symbol: "tail_table",
    };
